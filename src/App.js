...
import "./App.css";
import ShardContainer from "./components/ShardContainer";
...
function App() {
  ...
  return (
    <div className="App">
      <Header></Header>
      <ShardContainer shards={shards}></ShardContainer>
      <NFTContainer nfts={nfts}></NFTContainer>
      <TransmutationButton></TransmutationButton>
    </div>
  );
}
export default App;
